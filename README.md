...
Starburst [works](https://secure.travis-ci.org/starburstgem/starburst) on Rails 4.2, 5.0, 5.1, 5.2, 6.0, 6.1 and 7.0. It should work with the same Ruby runtime versions supported by each framework version.
